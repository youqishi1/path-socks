...
for file in path-socks-tls.service path-socks-tls.openrc sbb path-manager port.py renew.sh path-socks-renew.service path-socks-renew.timer checksums.txt; do
